...
export const ButtonIcon = ({
    ...
    return (
        <button
            ...
            {...props}
        >
            <span className="inset-0 absolute pointer-events-none rounded-[inherit] group-hover:before:opacity-[.2] group-hover:before:bg-[var(--color-bg-button-icon)] group-hover:before:inset-0 group-hover:before:absolute group-hover:before:rounded-[inherit]" />
            <span
                className={cn(
...
export const Button = ({
    ...
    return (
        <button
            className={cn(
                "inline-flex items-center justify-center select-none relative group rounded-[.5rem] py-0 cursor-pointer disabled:opacity-50 disabled:cursor-context-menu",
    ...
    return (
        <div className="text-sm/5 mt-2">
            <button
                ...
                onClick={onClick}
                className={cn(
                    "block max-w-[25rem] p-[0_1.5rem] min-w-20 h-11 text-base/[2.75rem] rounded-[1.375rem] font-bold m-[3rem_auto_0] select-none text-center whitespace-nowrap text-ellipsis overflow-hidden hover:bg-[var(--color-bg-hover-button-save)] hover:text-white",
                    disabled ? "disabled:cursor-not-allowed bg-[var(--color-bg-button-save-disabled)] text-white opacity-50" : "bg-[var(--color-bg-button-save)] text-[var(--color-text-button-save)]",
                    className ? className : ""
                )}
                {...props}
                style={{ width: "17.5rem" }}
